 ...
 * @author Th016
 */
public class InfoTeacher2 extends javax.swing.JFrame {
    
    /**
     * Creates new form InfoTeacher2
     */
    java.util.Date date;
...
//        boMonTF.getText()
//);
//ServiceModel.getTableModelFromSQLQuery(sqlSql, "hello");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoTeacher2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InfoTeacher2().setVisible(true);
            }
        });
    }
